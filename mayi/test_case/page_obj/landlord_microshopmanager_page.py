...
class LandlordMicroshopManagerPage(Pyse):
    ...
    def title(self):
        ...
        self.clear("xpath=>/html/body/div[13]/div[5]/div/div[7]/div[2]/div[2]/input")
        self.type("xpath=>/html/body/div[13]/div[5]/div/div[7]/div[2]/div[2]/input",text)

    #编辑微店弹窗——微店介绍
    def shop_introduction(self):
        text = mydef.rad_word(10)
        self.clear("xpath=>/html/body/div[13]/div[5]/div/div[7]/div[2]/div[3]/textarea")
        self.type("xpath=>/html/body/div[13]/div[5]/div/div[7]/div[2]/div[3]/textarea",text)
    ...
    def microshop_text(self):
        text = self.get_text("xpath=>/html/body/div[13]/div[5]/div/div")
        return text
