...
class LandlordWaitingcheckinPage(Pyse):
    ...
    #订单状态
    def status(self):
        text = self.get_text("xpath=>/html/body/div[13]/div[5]/div/div[2]/div/div/div[2]/div[5]/p[1]/span")
        return text

    #订单详情
    def wait_order_details(self):
        self.click("xpath=>/html/body/div[13]/div[5]/div/div[2]/div/div/div[2]/div[5]/p[2]/a")
